...
module.exports = "<app-header></app-header>\n<app-side-bar-menu ></app-side-bar-menu>\n<app-footer></app-footer>\n\n<!-- <div class=\"container\">\n    <h1>Welcome to Shared Technical Services</h1>\n        <mat-form-field> \n        Username\n        <input matInput [(ngModel)]=\"x_sts_user\">\n        </mat-form-field>\n                \n        <mat-form-field>\n        Password\n        <input matInput [type]=\"hide ? 'password' : 'text'\">\n        <mat-icon matSuffix (click)=\"hide = !hide\">{{hide ? 'visibility' : 'visibility_off'}}</mat-icon>\n        </mat-form-field>              \n    <mat-checkbox>Remember my login on this computer</mat-checkbox>\n</div>\n                \n<button routerLink=\"/dashboard\">Log In</button>\n<a href=\"\">Can't access your account?</a> -->"
...
var AdminLayoutComponent = /** @class */ (function () {
    ...
    AdminLayoutComponent = __decorate([
        core_1.Component({
            ...
            styles: [__webpack_require__(/*! ./admin-layout.component.scss */ "./src/app/admin-layout/admin-layout.component.scss")]
        }),
...
var side_bar_menu_component_1 = __webpack_require__(/*! ./side-bar-menu/side-bar-menu.component */ "./src/app/side-bar-menu/side-bar-menu.component.ts");
// import { AppRoutingModule } from './/app-routing.module';
var app_routing_1 = __webpack_require__(/*! ./app.routing */ "./src/app/app.routing.ts");
var on_board_user_component_1 = __webpack_require__(/*! ./on-board-user/on-board-user.component */ "./src/app/on-board-user/on-board-user.component.ts");
var admin_layout_component_1 = __webpack_require__(/*! ./admin-layout/admin-layout.component */ "./src/app/admin-layout/admin-layout.component.ts");
var auth_service_1 = __webpack_require__(/*! ./services/auth.service */ "./src/app/services/auth.service.ts");
var auth_guard_1 = __webpack_require__(/*! ./auth.guard */ "./src/app/auth.guard.ts");
var callback_component_1 = __webpack_require__(/*! ./callback/callback.component */ "./src/app/callback/callback.component.ts");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                on_board_user_component_1.OnBoardUserComponent,
...
var routes = [
    ...
    {
        path: 'on-board-user',
        component: on_board_user_component_1.OnBoardUserComponent,
        canActivate: [auth_guard_1.AuthGuard]
    },
    {
        path: 'dashboard',
...
module.exports = "<footer fxLayout=\"row\" fxLayoutAlign=\"start stretch\" >    \n    <div color=\"primary\">\n        Copyright © 2018, Kaiser Permanente.\n    </div>\n</footer>\n"
...
module.exports = "<section fxLayout=\"row\" fxLayoutAlign=\"start stretch\">\n  <mat-toolbar color=\"primary\" class=\"mat-elevation-z10\">\n      <mat-toolbar-row>\n        <div fxFlex=\"50\">\n          <img class=\"kp\" src=\"../../assets/KP_Signature_white_0817.png\">\n          <img class=\"cto\" src=\"../../assets/CTO-logo.png\">\n              <mat-icon class=\"title\">cloud</mat-icon> \n                  {{title}}\n              <!-- <p class=\"title\">{{title}}</p>-->\n        </div>\n      </mat-toolbar-row>\n  </mat-toolbar>\n</section>"
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent() {
        this.title = 'Shared Technical Services';
    }
...
/***/ "./src/app/on-board-user/on-board-user.component.html":
/*!************************************************************!*\
  !*** ./src/app/on-board-user/on-board-user.component.html ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "<app-header></app-header>\n<div class=\"container\">\n    <h1>\n        You have been entered into the Queue for allocation of services.\n        Please check back after 24 hours\n    </h1>\n</div>\n<app-footer></app-footer>"

/***/ }),

/***/ "./src/app/on-board-user/on-board-user.component.scss":
/*!************************************************************!*\
  !*** ./src/app/on-board-user/on-board-user.component.scss ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/app/on-board-user/on-board-user.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/on-board-user/on-board-user.component.ts ***!
  \**********************************************************/
/*! no static exports found */
...
var OnBoardUserComponent = /** @class */ (function () {
    ...
    OnBoardUserComponent = __decorate([
        core_1.Component({
            selector: 'app-on-board-user',
            template: __webpack_require__(/*! ./on-board-user.component.html */ "./src/app/on-board-user/on-board-user.component.html"),
            styles: [__webpack_require__(/*! ./on-board-user.component.scss */ "./src/app/on-board-user/on-board-user.component.scss")]
        }),
        __metadata("design:paramtypes", [])
...
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var router_1 = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
var auth0 = __webpack_require__(/*! auth0-js */ "./node_modules/auth0-js/dist/auth0.min.esm.js");
...
/***/ "./src/app/side-bar-menu/side-bar-menu.component.html":
/*!************************************************************!*\
  !*** ./src/app/side-bar-menu/side-bar-menu.component.html ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "<mat-toolbar-row color=\"primary\" class=\"mat-elevation-z6\" >\n<!-- <mat-toolbar-row color=\"primary\" class=\"mat-elevation-z6\" [ngClass]=\"{'invisibleMenu': !isUserLoggedIn}\">  -->\n  <button mat-icon-button>\n    <mat-icon (click)=\"sidenav.toggle()\">menu</mat-icon>\n  </button>\n    Menu\n      <!-- buttons on the right -->\n        <div fxFlex fxLayoutAlign=\"end\">\n          <button mat-icon-button >\n            <mat-icon>shopping_cart</mat-icon>\n          </button>\n          \n          <button mat-icon-button>\n            <mat-icon>settings</mat-icon>\n          </button>\n  \n          <button mat-icon-button [matMenuTriggerFor]=\"menu\">\n            <mat-icon>person</mat-icon>\n          </button>\n          <mat-menu #menu=\"matMenu\">\n            <button mat-menu-item (click)=\"logout()\" routerLink='/'>\n              <span>Logout</span>\n            </button>\n          </mat-menu>\n        </div>\n\n</mat-toolbar-row>\n\n<section class=\"container\" fxLayout=\"column\" fxLayoutAlign=\"start stretch\">\n<mat-sidenav-container color=\"accent\" fxFlex >\n\n<mat-sidenav #sidenav mode=\"side\" opened class=\"mat-elevation-z6\" >\n    <!-- <mat-list>\n      <mat-list-item *ngFor=\"let link of links\" href=\"...\" > {{ link.routerURL }} </mat-list-item>\n    </mat-list> -->\n\n     <ul>\n        <li class=\"text\">\n          <a class=\"noUnderline\" routerLink=\"/dashboard\"> \n            <i class=\"material-icons\">dashboard</i>\n            Dashboard\n          </a>\n        </li>\n\n        <li class=\"text\">\n            <a class=\"noUnderline\" [routerLink]=\"['iaas']\"> \n              <img src=\"../../assets/iaas.png\">\n              Infrastructure as a Service \n              <!-- (IaaS) -->\n            </a>\n        </li>\n\n        <li class=\"text\">\n            <a class=\"noUnderline\" [routerLink]=\"['dbaas']\">\n              <div class=\"text\">\n                  <img src=\"../../assets/dbaas.png\"> \n                  Database as a Service \n                  <!-- (DbaaS) -->\n              </div>\n            </a>\n        </li>\n\n        <li class=\"text\">\n            <a class=\"noUnderline\" [routerLink]=\"['lbaas']\"> \n              <img src=\"../../assets/lbaas.png\">\n              Load Balancer as a Service \n              <!-- (LbaaS) -->\n            </a>\n        </li>\n      </ul>\n</mat-sidenav>\n\n<router-outlet></router-outlet>\n\n</mat-sidenav-container>\n\n</section>"

/***/ }),

/***/ "./src/app/side-bar-menu/side-bar-menu.component.scss":
/*!************************************************************!*\
  !*** ./src/app/side-bar-menu/side-bar-menu.component.scss ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "li, ul {\n  list-style-type: none; }\n\nli:hover {\n  background-color: #519fff; }\n\ni {\n  font-size: 50px; }\n\nimg {\n  height: 50px;\n  width: 50px;\n  padding: 0; }\n\n.noUnderline {\n  text-decoration: none;\n  color: black; }\n\n.invisibleMenu {\n  visibility: hidden; }\n\n.sideNavDisplayNone {\n  display: none; }\n\n.text {\n  font-size: 20px; }\n\n.container {\n  height: 100vh; }\n\nmat-sidenav {\n  width: 25vw; }\n"

/***/ }),

/***/ "./src/app/side-bar-menu/side-bar-menu.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/side-bar-menu/side-bar-menu.component.ts ***!
  \**********************************************************/
/*! no static exports found */
...
var SideBarMenuComponent = /** @class */ (function () {
    ...
    function SideBarMenuComponent(auth) {
        this.auth = auth;
    }
    ...
    ], SideBarMenuComponent.prototype, "isUserLoggedIn", void 0);
    SideBarMenuComponent = __decorate([
        core_1.Component({
            selector: 'app-side-bar-menu',
            template: __webpack_require__(/*! ./side-bar-menu.component.html */ "./src/app/side-bar-menu/side-bar-menu.component.html"),
            styles: [__webpack_require__(/*! ./side-bar-menu.component.scss */ "./src/app/side-bar-menu/side-bar-menu.component.scss")]
        }),
        __metadata("design:paramtypes", [auth_service_1.AuthService])
...
module.exports = __webpack_require__(/*! /Users/farhanamustafa/Downloads/consumer-portal-test/src/main.ts */"./src/main.ts");
